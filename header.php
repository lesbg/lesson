...
if (! isset($noJS) || ! $noJS) {
	...
	src="js/<?php echo $extra_js?>"></script><?php
	}
}
...
<link rel="StyleSheet" href="css/standard.css" title="LES"
	type="text/css" media="screen">

<?php
if (isset($use_extra_css) && $use_extra_css == true) {
	?>
		<link rel="StyleSheet" href="css/standard.css" title="Regular"
	type="text/css" media="screen">
<link rel="StyleSheet" href="css/standard-agenda.css" title="Agenda"
	type="text/css" media="screen">
<link rel="StyleSheet" href="css/standard-hidden.css" title="Hidden"
	type="text/css" media="screen">
		<?php
}
?>
		<link rel="StyleSheet" href="css/print.css" title="Printable colors"
	type="text/css" media="print">
<link rel="Alternate StyleSheet" href="css/basic.css" title="Basic"
	type="text/css" media="screen">
</head>
<?php
if (isset($bodyClass)) {
