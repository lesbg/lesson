...
while ( $cRow = & $cRes->fetchrow(DB_FETCHMODE_ASSOC) ) {
    ...
    $data = str_replace("&lt;&lt;class_teacher_comment_t$termnum&gt;&gt;",
                        $ct_comment, $data);
    $data = str_replace("&lt;&lt;head_of_department_comment_t$termnum&gt;&gt;",
                        $hod_comment, $data);
...
$query = "SELECT classlist.Username, term.TermNumber, term.TermIndex, " .
         ...
         "  AND class.YearIndex = $yearindex) " .
         " ON term.TermIndex = classterm.TermIndex " . " INNER JOIN classlist " .
...
$data = str_replace("&lt;&lt;username&gt;&gt;",
                    htmlspecialchars($student_username, ENT_QUOTES), $data);
$data = str_replace("&lt;&lt;term&gt;&gt;",
                    htmlspecialchars($student_info['TermName'], ENT_QUOTES),
                    $data);
$data = str_replace("&lt;&lt;year&gt;&gt;",
                    htmlspecialchars($student_info['Year'], ENT_QUOTES), $data);
...
$data = str_replace("&lt;&lt;head_of_department_comment&gt;&gt;", $hod_comment,
                    $data);
...
while ( $pos != false ) {
    ...
    while ( $row = & $res->fetchRow(DB_FETCHMODE_ASSOC) ) {
        ...
        while ( $nrow = & $nres->fetchRow(DB_FETCHMODE_ASSOC) ) {
            ...
            $reprow = str_replace("&lt;&lt;subject_average_t$termnum&gt;&gt;",
                                htmlspecialchars($subject_average, ENT_QUOTES),
                                $reprow);
            $reprow = str_replace("&lt;&lt;subject_mark_t$termnum&gt;&gt;",
                                htmlspecialchars($average, ENT_QUOTES), $reprow);
            $reprow = str_replace("&lt;&lt;subject_effort_t$termnum&gt;&gt;",
                                htmlspecialchars($effort, ENT_QUOTES), $reprow);
            $reprow = str_replace("&lt;&lt;subject_conduct_t$termnum&gt;&gt;",
                                htmlspecialchars($conduct, ENT_QUOTES), $reprow);
            $reprow = str_replace("&lt;&lt;subject_comment_t$termnum&gt;&gt;",
                                $comment, $reprow);
        }
        ...
        $reprow = str_replace("&lt;&lt;overall_subject_average&gt;&gt;",
                            htmlspecialchars($subj_average, ENT_QUOTES), $reprow);
        $reprow = str_replace("&lt;&lt;overall_subject_mark&gt;&gt;",
                            htmlspecialchars($std_average, ENT_QUOTES), $reprow);
