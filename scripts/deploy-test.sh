#!/bin/sh
rsync --delete --exclude=.[a-z0-9]* -rtvzH ../lesson/ root@www:/www-data/html/secure/lesson-test
ssh -l root www "cd /www-data/html/secure/lesson-test/; patch -p1 < /srv/lesson-config-1.patch; chgrp apache ./ -Rh; chmod 640 ./ -R; chmod ug+X ./ -R;"
