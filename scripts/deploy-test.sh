...
#ssh -l root www.lesbg.loc "cd /www-data/html/secure/lesson/; patch -p1 < /srv/lesson-config-1.patch; chgrp apache ./ -Rh; chmod 640 ./ -R; chmod ug+X ./ -R; ln -s ../lesson; ln -s /networld/system_data/tftpboot/linux-install netboot"
...
#ssh -l root www.lesaz.loc "cd /var/www/html/lesson/; patch -p1 < /srv/lesson-config-1.patch; chgrp apache ./ -Rh; chmod 640 ./ -R; chmod ug+X ./ -R; ln -s ../lesson;"
