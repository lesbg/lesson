<?php
	...
	if($is_principal or $is_hod or $is_counselor or $is_classteacher or $is_supportteacher or $is_teacher) {
		...
		if($_POST["action"] == "Save" or $_POST["action"] == "Update") { // If update or save were pressed, print  
			...
			if($_POST['note'] == "") {
				...
				if($_POST["action"] == "Save") {
					...
					echo " done</p>\n";
					log_event($LOG_LEVEL_TEACHER, "teacher/casenote/new_action.php", $LOG_TEACHER,
						"Created new casenote for $student.");
				} else {
				}
			}
		...
		log_event($LOG_LEVEL_ERROR, "teacher/casenote/new_action.php", $LOG_DENIED_ACCESS,
					"Tried to create new casenote for $student.");
