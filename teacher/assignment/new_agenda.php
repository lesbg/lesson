<?php
	...
	if($res->numRows() > 0 or $is_admin) {
		...
		echo "      </script>\n";
		echo "      <form action='$link' method='post' name='agenda'>\n";        // Form method
		...
		log_event($LOG_LEVEL_ERROR, "teacher/assignment/new_agenda.php", $LOG_DENIED_ACCESS, 
					"Tried to create new agenda item for $subtitle.");
