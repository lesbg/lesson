...
if ($_POST["action"] == "Save" or $_POST["action"] == "Update" or
     $_POST["action"] == "Move this assignment to next term" or
     $_POST["action"] == "Convert to agenda item" or
     $_POST["action"] == "Convert to assignment") { // If update or save were pressed, print
