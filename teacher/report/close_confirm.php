<?php
	...
	if($res->numRows() == 0 and !$is_admin and !$is_hod and !$is_principal) {
		log_event($LOG_LEVEL_ERROR, "teacher/report/close_confirm.php", $LOG_DENIED_ACCESS,
				"Tried to close reports for $subject.");
		echo "      <p>You do not have the authority to close these reports.  <a href='$nextLink'>" .
		              "Click here to continue</a>.</p>\n";
	}

	$link          = "index.php?location=" . dbfuncString2Int("teacher/report/close_action.php") .
					 "&amp;key=" .               $_GET['key'] .
