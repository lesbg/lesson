<?php
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN) or $perm == 1) {
		...
		if($_POST["action"] == "Yes, close punishment")  {
			...
			log_event($LOG_LEVEL_TEACHER, "teacher/punishment/date/close.php", $LOG_TEACHER,
						"Closed punishment attendance.");
		...
		log_event($LOG_LEVEL_ERROR, "teacher/punishment/date/close.php", $LOG_DENIED_ACCESS,
				"Attempted to close punishment attendance.");
