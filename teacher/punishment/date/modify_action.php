<?php
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN) or $perm == 1) {
		...
		if($_POST["action"] == "Done" or $_POST["action"] == "Close")  {
			...
			log_event($LOG_LEVEL_TEACHER, "teacher/punishment/date/modify_action.php", $LOG_TEACHER,
		...
		log_event($LOG_LEVEL_ERROR, "teacher/punishment/date/modify_action.php", $LOG_DENIED_ACCESS,
				"Attempted to check punishment attendance.");
