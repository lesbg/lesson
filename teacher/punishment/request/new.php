<?php
	/*****************************************************************
	 * teacher/punishment/request/new.php  (c) 2006 Jonathan Dieter
	 *
	...
	$link             = "index.php?location=" . dbfuncString2Int("teacher/punishment/request/new_action.php") .
						"&amp;key=" .           $_GET['key'] .
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN) or $perm >= $PUN_PERM_REQUEST) {
		...
		log_event($LOG_LEVEL_ERROR, "teacher/punishment/request/new.php", $LOG_DENIED_ACCESS, 
