	...
	if($_POST['action'] == "Yes, re-instate punishment") {
		...
		if($row =& $res->fetchRow(DB_FETCHMODE_ASSOC)) {
			...
			if($is_admin or $row['WorkerUsername'] == $username) {
				...
				log_event($LOG_LEVEL_TEACHER, "teacher/punishment/request/delete_removal.php", $LOG_TEACHER,
						"Re-instated $log_pun for $name.");
				
				echo "      <p align='center'><a href='$nextLink'>Continue</a></p>\n";
			} else {
				log_event($LOG_LEVEL_ERROR, "teacher/punishment/request/delete_removal.php", $LOG_DENIED_ACCESS,
