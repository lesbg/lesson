<?php
	...
	if($is_admin or $is_class_teacher or $res->numRows() > 0) {
		...
		log_event($LOG_LEVEL_EVERYTHING, "teacher/book/choose_book_number.php", $LOG_ADMIN,
				"Chose book number for $booktitle.");
	} else {
		/* Log unauthorized access attempt */
		log_event($LOG_LEVEL_ERROR, "teacher/book/choose_book_number.php", $LOG_DENIED_ACCESS,
