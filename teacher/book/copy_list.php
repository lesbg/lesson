...
/**
 * ***************************************************************
 * teacher/book/copy_list.php (c) 2010, 2018 Jonathan Dieter
 *
 * List copies of a book
 * ***************************************************************
 */
$book_title = dbfuncInt2String($_GET['keyname']);
$title = "Copies of $book_title";
...
$class_index = intval(dbfuncInt2String($_GET['key3']));
...
if (! $is_admin and !$row) {
    ...
    log_event($LOG_LEVEL_ERROR, "teacher/book/copy_list.php",
...
$newlink = "index.php?location=" .
         dbfuncString2Int("teacher/book/new_copy.php") . "&amp;key=" .
         ...
         dbfuncString2Int(
                        "index.php?location=" .
                         ...
                         "&amp;key3=" . $_GET['key3']);
$newbutton = dbfuncGetButton($newlink, "New copy", "medium", "",
                            "Add new copy of this book");
if ($showall) {
    $salink = "index.php?location=" .
             dbfuncString2Int("teacher/book/copy_list.php") . "&amp;key=" .
             $_GET['key'] . "&amp;keyname=" . $_GET['keyname'] . "&amp;key2=" .
             dbfuncString2Int("0") . "&amp;key3=" . $_GET['key3'];
    $sabutton = dbfuncGetButton($salink, "Show active copies", "medium", "",
                                "Show only active copies and not retired copies");
} else {
    $salink = "index.php?location=" .
             dbfuncString2Int("teacher/book/copy_list.php") . "&amp;key=" .
             $_GET['key'] . "&amp;keyname=" . $_GET['keyname'] . "&amp;key2=" .
             dbfuncString2Int("1") . "&amp;key3=" . $_GET['key3'];
    $sabutton = dbfuncGetButton($salink, "Show all copies", "medium", "",
                                "Show all copies, including retired ones");
}
...
$query =
    ...
    "      ) USING (BookIndex) " .
    " WHERE book.BookTitleIndex = :book_title_index ";
if (! $showall) {
    $query .=
        " AND book.Retired=0 ";
}
$query .=
    " ORDER BY book.BookNumber, book.BookIndex, book_status.Order DESC " .
...
if ($data) {
    ...
    foreach($query as $row) {
        ...
        $viewlink = "index.php?location=" .
                     dbfuncString2Int("teacher/book/copy_history.php") .
                     "&amp;key=" . dbfuncString2Int($row['BookIndex']) .
                     "&amp;keyname=" .
                     dbfuncString2Int(
                                    $book_title . " copy #" . $row['BookNumber']) .
                     "&amp;next=" .
                     dbfuncString2Int(
                                    "index.php?location=" .
                                     dbfuncString2Int(
                                                    "teacher/book/copy_list.php") .
                                     "&amp;key=" . $_GET['key'] . "&amp;keyname=" .
                                     $_GET['keyname'] . "&amp;key2=" .
                                     $_GET['key2'] . "&amp;key3=" .
                                     $_GET['key3']);
        $retlink = "index.php?location=" .
                 dbfuncString2Int("teacher/book/retire_copy_confirm.php") .
                 "&amp;key=" . dbfuncString2Int($row['BookIndex']) .
                 "&amp;keyname=" .
                 dbfuncString2Int($book_title . " copy #" . $row['BookNumber']) .
                 "&amp;next=" .
                 dbfuncString2Int(
                                "index.php?location=" .
                                 dbfuncString2Int("teacher/book/copy_list.php") .
                                 ...
                                 $_GET['keyname'] . "&amp;key2=" . $_GET['key2'] .
                                 "&amp;key3=" . $_GET['key3']);
        $unrlink = "index.php?location=" .
                 dbfuncString2Int("teacher/book/unretire_copy_confirm.php") .
                 "&amp;key=" . dbfuncString2Int($row['BookIndex']) .
                 "&amp;keyname=" .
                 dbfuncString2Int($book_title . " copy #" . $row['BookNumber']) .
                 "&amp;next=" .
                 dbfuncString2Int(
                                "index.php?location=" .
                                 ...
                                 $_GET['keyname'] . "&amp;key2=" . $_GET['key2'] .
                                 "&amp;key3=" . $_GET['key3']);
        $colink = "index.php?location=" .
                 dbfuncString2Int("teacher/book/check_in_out_copy.php") .
                 "&amp;key=" . dbfuncString2Int($row['BookIndex']) .
                 "&amp;keyname=" .
                 dbfuncString2Int($book_title . " copy #" . $row['BookNumber']) .
                 "&amp;key2=" . dbfuncString2Int(2) . "&amp;key3=" .
                 $_GET['key3'] . "&amp;next=" .
                 dbfuncString2Int(
                                "index.php?location=" .
                                 dbfuncString2Int("teacher/book/copy_list.php") .
                                 ...
                                 $_GET['keyname'] . "&amp;key2=" . $_GET['key2'] .
                                 "&amp;key3=" . $_GET['key3']);
        $cilink = "index.php?location=" .
                 dbfuncString2Int("teacher/book/check_in_out_copy.php") .
                 "&amp;key=" . dbfuncString2Int($row['BookIndex']) .
                 "&amp;keyname=" .
                 dbfuncString2Int($book_title . " copy #" . $row['BookNumber']) .
                 "&amp;key2=" . dbfuncString2Int(1) . "&amp;key3=" .
                 $_GET['key3'] . "&amp;next=" .
                 dbfuncString2Int(
                                "index.php?location=" .
                                 dbfuncString2Int("teacher/book/copy_list.php") .
        ...
        $cobutton = dbfuncGetButton($colink, "O", "small", "cn",
                                    "Check out copy");
        $cibutton = dbfuncGetButton($cilink, "I", "small", "msg",
                                    "Check in copy");
        $viewbutton = dbfuncGetButton($viewlink, "V", "small", "view",
                                    "View history of this copy");
        $retbutton = dbfuncGetButton($retlink, "R", "small", "delete",
                                    "Retire copy");
        $unrbutton = dbfuncGetButton($unrlink, "U", "small", "msg",
                                    "Unretire copy");
        echo "            <td>";
        if ($row['Retired']) {
            echo "&nbsp;&nbsp;";
        ...
        } elseif ($row['BookStatusTypeIndex'] == 3 or
                 $row['BookStatusTypeIndex'] == 1) {
