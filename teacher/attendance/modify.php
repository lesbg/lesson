<?php
	...
	if($res->numRows() > 0 or dbfuncGetPermission($permissions, $PERM_ADMIN)) {
		$link             = "index.php?location=" . dbfuncString2Int("teacher/attendance/modify_action.php") .
							"&amp;key=" .           $_GET['key'] .
							"&amp;key2=" .          $_GET['key2'] .
							"&amp;key3=" .          $_GET['key3'] .
		...
		log_event($LOG_LEVEL_ERROR, "teacher/attendance/modify.php", $LOG_DENIED_ACCESS,
