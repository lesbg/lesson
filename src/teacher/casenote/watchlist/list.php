...
/**
 * ***************************************************************
 * teacher/casenote/watchlist/list.php (c) 2005, 2018 Jonathan Dieter
 *
...
$classAsc = dbfuncGetButton(
                            "index.php?location=" .
                             dbfuncString2Int(
                                            "teacher/casenote/watchlist/list.php") .
                             "&amp;sort=2", "A", "small", "sort",
                            "Sort ascending");
$classDec = dbfuncGetButton(
                            "index.php?location=" .
                             ...
                             "&amp;sort=3", "D", "small", "sort",
                            "Sort descending");
$newcnAsc = dbfuncGetButton(
                            "index.php?location=" .
                             dbfuncString2Int(
                                            "teacher/casenote/watchlist/list.php") .
                             "&amp;sort=8", "A", "small", "sort",
                            "Sort ascending");
$newcnDec = dbfuncGetButton(
                            "index.php?location=" .
                             dbfuncString2Int(
                                            "teacher/casenote/watchlist/list.php") .
                             "&amp;sort=9", "D", "small", "sort",
...
$query->execute(['username' => $username, 'currentyear' => $currentyear,
