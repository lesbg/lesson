...
/**
 * ***************************************************************
 * teacher/assignment/print_gradesheet.php (c) 2005-2006, 2018 Jonathan Dieter
 *
...
$subject_index = safe(dbfuncInt2String($_GET['key']));
...
/* Check whether user is authorized to view printable marksheet */
