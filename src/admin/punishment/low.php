...
/**
 * ***************************************************************
 * admin/punishment/low.php (c) 2007-2016 Jonathan Dieter
 *
...
if ($is_admin or ($perm >= $PUN_PERM_SEE and $is_teacher)) { // Make sure user has permission to view
	...
	$classAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/punishment/low.php") .
								 "&amp;sort=0&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[0]}", "Sort ascending");
	$classDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/punishment/low.php") .
								 "&amp;sort=1&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[1]}", "Sort descending");
	$unameAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/punishment/low.php") .
								 "&amp;sort=2&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[2]}", "Sort ascending");
	$unameDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/punishment/low.php") .
								 "&amp;sort=3&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[3]}", "Sort descending");
	$scoreAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/punishment/low.php") .
								 "&amp;sort=8&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[8]}", "Sort ascending");
	$scoreDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/punishment/low.php") .
								 "&amp;sort=9&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;start={$_GET['start']}", 
	...
	if (intval($start) > 0) {
		$first_record = dbfuncGetButton(
										"index.php?location=" .
											 dbfuncString2Int(
															"admin/punishment/low.php") .
											 "&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;sort={$_GET['sort']}&amp;start=0", 
											"<<", "medium", "prevnext", 
											"First page");
		...
		$prev_record = dbfuncGetButton(
									"index.php?location=" .
									 dbfuncString2Int(
													"admin/punishment/low.php") .
									 "&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;sort={$_GET['sort']}&amp;start=$prev", 
	...
	if (intval($start) < $fpstart) {
		$last_record = dbfuncGetButton(
									"index.php?location=" .
										 dbfuncString2Int(
														"admin/punishment/low.php") .
										 "&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;sort={$_GET['sort']}&amp;start=$fpstart", 
		...
		$next_record = dbfuncGetButton(
									"index.php?location=" .
									 dbfuncString2Int(
													"admin/punishment/low.php") .
									 "&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;sort={$_GET['sort']}&amp;start=$next", 
