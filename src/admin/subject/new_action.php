...
if ($is_admin) {
	...
	$query = "SELECT SubjectIndex FROM subject " .
			 ...
			 "AND   YearIndex =  $yearindex " . "AND   TermIndex =  $termindex ";
	...
	if ($row = & $res->fetchRow(DB_FETCHMODE_ASSOC)) {
		...
		/* Add new subject */
		$aRes = & $db->query(
							"INSERT INTO subject (Name, YearIndex, TermIndex, Period, SubjectTypeIndex, " .
		...
		$aRes = & $db->query(
					"SELECT SubjectIndex, Name FROM subject " .
