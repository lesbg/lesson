...
if ($classindex == "NULL" or $classindex == "")
    $classindex = NULL;
else
    $classindex = intval($classindex);
if ($gradeindex == "NULL" or $gradeindex == "")
    $gradeindex = NULL;
else
    $gradeindex = intval($gradeindex);

$link = "index.php?location=" .
         dbfuncString2Int("admin/subject/modify_list_action.php") . "&amp;key=" .
