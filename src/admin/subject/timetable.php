...
if (dbfuncGetPermission($permissions, $PERM_ADMIN)) {
	$res = &  $db->query(
					"SELECT period.PeriodName, period.StartTime, period.EndTime, day.Day, " .
	...
	log_event($LOG_LEVEL_ERROR, "admin/subject/timetable.php", 
			$LOG_DENIED_ACCESS, "Tried to access timetable for $name.");
