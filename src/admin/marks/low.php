...
if (dbfuncGetPermission($permissions, $PERM_ADMIN)) { // Make sure user has permission to view
	...
	$classAsc = dbfuncGetButton(
								"index.php?location=" .
								 ...
								 "&amp;sort=0&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[0]}", "Sort ascending");
	$classDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=1&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[1]}", "Sort descending");
	$unameAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=2&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[2]}", "Sort ascending");
	$unameDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=3&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[3]}", "Sort descending");
	$subjectAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=4&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[4]}", "Sort ascending");
	$subjectDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=5&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[5]}", "Sort descending");
	$titleAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=6&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[6]}", "Sort ascending");
	$titleDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=7&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[7]}", "Sort descending");
	$scoreAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=8&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[8]}", "Sort ascending");
	$scoreDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=9&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[9]}", "Sort descending");
	$averageAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=10&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[10]}", "Sort ascending");
	$averageDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=11&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[11]}", "Sort descending");
	$diffAsc = dbfuncGetButton(
							"index.php?location=" .
							 dbfuncString2Int("admin/marks/low.php") .
							 "&amp;sort=12&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
							"A", "small", "{$sort[12]}", "Sort ascending");
	$diffDec = dbfuncGetButton(
							"index.php?location=" .
							 dbfuncString2Int("admin/marks/low.php") .
							 "&amp;sort=13&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
							"D", "small", "{$sort[13]}", "Sort descending");
	$dateAsc = dbfuncGetButton(
							"index.php?location=" .
							 dbfuncString2Int("admin/marks/low.php") .
							 "&amp;sort=14&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
							"A", "small", "{$sort[14]}", "Sort ascending");
	$dateDec = dbfuncGetButton(
							"index.php?location=" .
							 dbfuncString2Int("admin/marks/low.php") .
							 "&amp;sort=15&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
							"D", "small", "{$sort[15]}", "Sort descending");
	$duedateAsc = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=16&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"A", "small", "{$sort[16]}", "Sort ascending");
	$duedateDec = dbfuncGetButton(
								"index.php?location=" .
								 dbfuncString2Int("admin/marks/low.php") .
								 "&amp;sort=17&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;start={$_GET['start']}", 
								"D", "small", "{$sort[17]}", "Sort descending");
	...
	$query = "SELECT COUNT(MarkIndex) AS Count " .
			 ...
			 "AND   subject.TermIndex = $termindex " . "AND   Date >= '$sdate' " .
			 "AND   Date <= '$edate' " .
	...
	$query = "SELECT FirstName, Surname, mark.Username, " .
			 ...
			 "       ClassName, class.Grade, " . "       Percentage, Comment " .
			 "       FROM mark " .
			 ...
			 "AND   Date <= '$edate' " .
			 "AND   Percentage < assignment.Average - $fdata " .
			 "AND   (Score >= 0 OR Score = $MARK_LATE) " . "$sortorder " .
	...
	if (intval($start) > 0) {
		$first_record = dbfuncGetButton(
										"index.php?location=" .
											 dbfuncString2Int(
															"admin/marks/low.php") .
											 "&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;sort={$_GET['sort']}&amp;start=0", 
											"<<", "medium", "prevnext", 
											"First page");
		...
		$prev_record = dbfuncGetButton(
									"index.php?location=" .
									 dbfuncString2Int("admin/marks/low.php") .
									 "&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;sort={$_GET['sort']}&amp;start=$prev", 
	...
	if (intval($start) < $fpstart) {
		$last_record = dbfuncGetButton(
									"index.php?location=" .
										 dbfuncString2Int("admin/marks/low.php") .
										 "&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;sort={$_GET['sort']}&amp;start=$fpstart", 
		...
		$next_record = dbfuncGetButton(
									"index.php?location=" .
									 dbfuncString2Int("admin/marks/low.php") .
									 "&amp;show={$_GET['show']}&amp;fdata={$_GET['fdata']}&amp;ftype={$_GET['ftype']}&amp;edate={$_GET['edate']}&amp;sdate={$_GET['sdate']}&amp;sort={$_GET['sort']}&amp;start=$next", 
	...
	while ( $row = & $res->fetchRow(DB_FETCHMODE_ASSOC) ) {
		...
		if (DB::isError($teacherRes))
			die($teacherRes->getMessage()); // Check for errors in query
