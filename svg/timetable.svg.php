...
/**
 * ***************************************************************
 * svg/timetable.svg.php (c) 2007, 2016 Jonathan Dieter
 *
 * Show timetable
 * ***************************************************************
 */
...
echo "<?xml-stylesheet href='../css/standard.css' type='text/css' name='std' ?>\n";*/
...
echo "<div align='center'><svg width='800' height='400' version='1.1' viewBox='$rleft $rtop $rwidth $rheight' xmlns='http://www.w3.org/2000/svg' xml:space='preserve'>";
...
if ($tttype == "c" or $username == $ttusername or $is_guardian or
