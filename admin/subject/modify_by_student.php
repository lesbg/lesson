...
$link = "index.php?location=" .
		 dbfuncString2Int("admin/subject/modify_by_student_action.php") .
...
if (dbfuncGetPermission($permissions, $PERM_ADMIN)) {
	...
	$res = &  $db->query(
					"SELECT subject.Name, subject.SubjectIndex FROM subject, subjectstudent " .
	...
	$res = &  $db->query(
					"SELECT class.ClassIndex FROM classlist, classterm, class " .
