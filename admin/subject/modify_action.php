...
if ($is_admin) {
	...
	if (! isset($_POST['period']) or is_null($_POST['period']) or
		 $_POST['period'] == 0) {
		$_POST['period'] = "NULL";
	}
	/* Change subject */
	$query = "UPDATE subject SET " . "  Name='{$_POST['name']}', " .
			 "  Period={$_POST['period']}, " .
			 "  SubjectTypeIndex={$_POST['subjecttype']}, " .
			 "  ClassIndex={$_POST['class']}, " . "  Grade={$_POST['grade']}, " .
	...
	log_event($LOG_LEVEL_ERROR, "admin/subject/modify_action.php", 
			$LOG_DENIED_ACCESS, 
