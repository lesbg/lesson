<?php
	...
	$link             = "index.php?location=" . dbfuncString2Int("admin/subjecttype/new_or_modify_action.php") .
						"&amp;key=" .           $_GET['key'] .
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN)) {
		...
		$fRes =& $db->query("SELECT Title, Description FROM subjecttype " . 
		...
		log_event($LOG_LEVEL_ERROR, "admin/subjecttype/modify.php", $LOG_DENIED_ACCESS,
