<?php
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN)) {
		$aRes =& $db->query("UPDATE subjecttype SET Title={$_POST['title']}, Description={$_POST['descr']} " . 
		...
		log_event($LOG_LEVEL_ERROR, "admin/subjecttype/modify_action.php", $LOG_DENIED_ACCESS,
