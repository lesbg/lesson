<?php
	...
	$link             = "index.php?location=" . dbfuncString2Int("admin/class_term/modify_action.php") .
						"&amp;key=" .           $_GET['key'] .
						"&amp;key2=" .          $_GET['key2'] .
	...
	if(!$is_admin) {
		log_event($LOG_LEVEL_ERROR, "admin/class_term/modify.php", $LOG_DENIED_ACCESS,
	...
	if(isset($errorlist)) echo $errorlist;
