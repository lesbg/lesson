<?php
	...
	if(!$is_admin) {
		...
		include "header.php";
		log_event($LOG_LEVEL_ERROR, "admin/class_term/modify_action.php", $LOG_DENIED_ACCESS,
	...
	if($_POST['action'] == "Update") {
		...
		if(!isset($_FILES['report_template']) or $_FILES['report_template']['error'] != UPLOAD_ERR_OK) {
			...
			$nres =& $db->query($query);
			if(DB::isError($nres)) die($nres->getUserInfo());
		}
