<?php
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN) or $perm > $PUN_PERM_ALL) {
		...
		$link             = "index.php?location=" . dbfuncString2Int("admin/punishment/date_student_action.php") .
							"&amp;type=" .          $_GET['type'] .
							"&amp;next=" .          $_GET['next'];
		...
		log_event($LOG_LEVEL_ERROR, "admin/punishment/date_student.php", $LOG_DENIED_ACCESS,
