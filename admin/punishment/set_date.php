<?php
	/*****************************************************************
	 * admin/punishment/set_date.php  (c) 2006 Jonathan Dieter
	 *
	...
	if(isset($_GET['type'])) {
		...
		if(isset($_POST['type'])) {
			...
			$link =		"index.php?location=" . dbfuncString2Int("admin/punishment/set_date.php") .
						"&amp;next=" .          $_GET['next'];
	...
	$link =		"index.php?location=" . dbfuncString2Int("admin/punishment/set_date_action.php") .
				"&amp;type=" .          $_GET['type'] .
				"&amp;key=" .           dbfuncString2Int($pindex) .
				"&amp;next=" .          $_GET['next'];
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN) or $perm >= $PUN_PERM_ALL) {
		...
		log_event($LOG_LEVEL_ERROR, "admin/punishment/set_date.php", $LOG_DENIED_ACCESS, 
