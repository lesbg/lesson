...
/**
 * ***************************************************************
 * admin/punishment/list_date.php (c) 2006-2016 Jonathan Dieter
 *
...
if (dbfuncGetPermission($permissions, $PERM_ADMIN) or
	...
	log_event($LOG_LEVEL_ERROR, "admin/punishment/list_date.php", 
			$LOG_DENIED_ACCESS, "Tried to view punishment date information.");
