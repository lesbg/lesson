...
if (! $is_admin and ($perm < $PUN_PERM_MASS or ! $is_teacher)) {
	log_event($LOG_LEVEL_ERROR, "admin/punishment/tools.php", 
			$LOG_DENIED_ACCESS, "Tried to access punishment tools.");
...
log_event($LOG_LEVEL_EVERYTHING, "admin/punishment/tools.php", $LOG_ADMIN, 
		"Accessed punishment tools.");

$masspunLink = "index.php?location=" .
			 dbfuncString2Int("admin/punishment/mass.php") . "&amp;next=" .
			 dbfuncString2Int(
							"index.php?location=" .
							 dbfuncString2Int("admin/punishment/tools.php"));
$reviewpendpunLink = "index.php?location=" .
					 dbfuncString2Int("admin/punishment/review_pending.php") .
					 "&amp;next=" .
					 dbfuncString2Int(
									"index.php?location=" .
									 dbfuncString2Int(
													"admin/punishment/tools.php"));
$punlistLink = "index.php?location=" .
			 dbfuncString2Int("admin/punishment/list.php");
$viewpunLink = "index.php?location=" .
			 dbfuncString2Int("admin/punishment/list_date.php");
$setdateLink = "index.php?location=" .
			 dbfuncString2Int("admin/punishment/date_student.php") . "&amp;next=" .
			 dbfuncString2Int(
							"index.php?location=" .
							 dbfuncString2Int("admin/punishment/tools.php"));
$proxypunLink = "index.php?location=" .
				 dbfuncString2Int("admin/punishment/proxy.php") . "&amp;next=" .
				 dbfuncString2Int(
								"index.php?location=" .
								 dbfuncString2Int("admin/punishment/tools.php"));
$attendanceLink = "index.php?location=" .
				 dbfuncString2Int("admin/attendance/first_period.php");
$printattLink = "index.php?location=" .
				 dbfuncString2Int("admin/print/attendance.php");
$lowconductLink = "index.php?location=" .
				 dbfuncString2Int("admin/punishment/low.php");
$alLink = "index.php?location=" .
		 dbfuncString2Int("admin/attendance/list.php");
