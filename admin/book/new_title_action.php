...
if ($is_admin) {
	/* Add new book type */
	$res = &  $db->query(
					"INSERT INTO book_title (BookTitle, BookTitleIndex, Cost) " .
					 "VALUES ('$title', '$id', $cost)");
	if (DB::isError($res))
		die($res->getDebugInfo()); // Check for errors in query
	
	$res = &  $db->query(
					"INSERT INTO book_title_owner (BookTitleIndex, YearIndex, Username) " .
	...
	log_event($LOG_LEVEL_ERROR, "admin/book/new_title_action.php", 
			$LOG_DENIED_ACCESS, 
