<?php
	...
	if($is_admin) {
		...
		$newlink =  "index.php?location=" .  dbfuncString2Int("admin/book/new_title.php") .
					"&amp;next=" .           dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/book/title_list.php"));
		$newbutton = dbfuncGetButton($newlink, "New title", "medium", "", "Create new title");
		...
		if($res->numRows() > 0) {
			...
			while ($row =& $res->fetchRow(DB_FETCHMODE_ASSOC)) {
				...
				$viewlink = "index.php?location=" .  dbfuncString2Int("admin/book/copies_list.php") .
							...
							"&amp;next=" .           dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/book/title_list.php"));
				$dellink  = "index.php?location=" .  dbfuncString2Int("admin/book/delete_title_confirm.php") .
							"&amp;key=" .            dbfuncString2Int($row['BookTitleIndex']) .
							"&amp;keyname=" .        dbfuncString2Int($row['BookTitle']) .
							"&amp;next=" .           dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/book/title_list.php"));
				$editlink = "index.php?location=" .  dbfuncString2Int("admin/book/modify_title.php") .
							"&amp;key=" .            dbfuncString2Int($row['BookTitleIndex']) .
							"&amp;keyname=" .        dbfuncString2Int($row['BookTitle']) .
							"&amp;next=" .           dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/book/title_list.php"));
