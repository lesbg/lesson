<?php
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN)) {           // Make sure user has permissions
		log_event($LOG_LEVEL_ADMIN, "admin/tools.php", $LOG_ADMIN, "Accessed administrative tools.");
		...
		*/
		...
		$studentListLink = "index.php?location=" . dbfuncString2Int("admin/studentlist.php");
		$teacherListLink = "index.php?location=" . dbfuncString2Int("admin/teacherlist.php");
		$subjectListLink = "index.php?location=" . dbfuncString2Int("admin/subject/list.php");
		$subtypeListLink = "index.php?location=" . dbfuncString2Int("admin/subjecttype/list.php");
		$catListLink     = "index.php?location=" . dbfuncString2Int("admin/category/list.php");
		$commentLink     = "index.php?location=" . dbfuncString2Int("admin/comment/list.php");
		$classListLink   = "index.php?location=" . dbfuncString2Int("admin/class/list.php");
		...
		$bookLink        = "index.php?location=" . dbfuncString2Int("admin/book/title_list.php");
		$messageLink     = "index.php?location=" . dbfuncString2Int("user/messages.php");
		$lowmarksLink    = "index.php?location=" . dbfuncString2Int("admin/marks/low.php");
		$proofLink       = "index.php?location=" . dbfuncString2Int("admin/proofreader/list.php");
		$supportLink     = "index.php?location=" . dbfuncString2Int("admin/support/modify.php") .
												  "&amp;next=" . dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/tools.php"));
		...
		log_event($LOG_LEVEL_ERROR, "admin/tools.php", $LOG_DENIED_ACCESS, "Tried to access administrative tools.");
