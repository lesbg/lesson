<?php
	...
	if($is_admin) {
		...
		$newlink =  "index.php?location=" .  dbfuncString2Int("admin/category/new.php") .
					"&amp;next=" .           dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/category/list.php"));
		$newbutton = dbfuncGetButton($newlink, "New category type", "medium", "", "Create new category type");
		...
		if($res->numRows() > 0) {
			...
			while ($row =& $res->fetchRow(DB_FETCHMODE_ASSOC)) {
				...
				$viewlink = "index.php?location=" .  dbfuncString2Int("admin/category/list_subjects php") .
							...
							"&amp;next=" .           dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/category/list.php"));*/
				$viewlink = "";
				$dellink =  "index.php?location=" .  dbfuncString2Int("admin/category/delete_confirm.php") .
							"&amp;key=" .            dbfuncString2Int($row['CategoryIndex']) .
							"&amp;keyname=" .        dbfuncString2Int($row['CategoryName']) .
							"&amp;next=" .           dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/category/list.php"));
				$editlink = "index.php?location=" .  dbfuncString2Int("admin/category/modify.php") .
							"&amp;key=" .            dbfuncString2Int($row['CategoryIndex']) .
							"&amp;keyname=" .        dbfuncString2Int($row['CategoryName']) .
							"&amp;next=" .           dbfuncString2Int("index.php?location=" . dbfuncString2Int("admin/category/list.php"));
				...
				$viewbutton = dbfuncGetButton($viewlink, "V", "small", "view", "View subjects using this category");
				$editbutton = dbfuncGetButton($editlink, "E", "small", "edit", "Edit category");
				$delbutton  = dbfuncGetButton($dellink,  "X", "small", "delete", "Delete category");
