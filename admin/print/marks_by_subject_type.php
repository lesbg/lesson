<?php
	...
	/* Get variables */
	$title            = dbfuncInt2String($_GET['keyname']) . " " . dbfuncInt2String($_GET['key2name']);
	...
	if(dbfuncGetPermission($permissions, $PERM_ADMIN)) {
		...
		log_event($LOG_LEVEL_EVERYTHING, "admin/print/marks_by_subject_type.php", $LOG_ADMIN,
				"Accessed printable marks for $title.");
	} else {  // User isn't authorized to view or change scores.
		/* Log unauthorized access attempt */
		log_event($LOG_LEVEL_ERROR, "admin/print/marks_by_subject_type.php", $LOG_DENIED_ACCESS,
					"Tried to access printable marks for $title.");
