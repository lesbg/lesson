	...
	if ($res->numRows() > 0) {
		...
		while ( $row = & $res->fetchRow(DB_FETCHMODE_ASSOC) ) {
			...
			$editlink = "index.php?location=" .
						 dbfuncString2Int("admin/proofreader/modify.php") .
						 "&amp;key=" .
						 dbfuncString2Int($row['DepartmentIndex']) .
						 "&amp;keyname=" .
						 dbfuncString2Int($row['Department']) . "&amp;key2=" .
			...
			$editbutton = dbfuncGetButton($editlink, "E", "small", "edit", 
										"Change proofreader for department");
